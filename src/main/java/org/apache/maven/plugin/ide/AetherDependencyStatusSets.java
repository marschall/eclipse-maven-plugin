 ...
 */
public class AetherDependencyStatusSets
{
     ...
     * Default ctor.
     */
    public AetherDependencyStatusSets()
    {
     ...
     */
    public AetherDependencyStatusSets( Set<Artifact> resolved, Set<Artifact> unResolved, Set<Artifact> skipped )
    {
        if ( resolved != null )
        {
